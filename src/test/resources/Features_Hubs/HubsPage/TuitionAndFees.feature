...
Feature: As a student viewing new Hubs' Costs tab, I want to see a top bar with at-a-glance information so that I get
  ...
  Scenario: Tuition Fees for In-State is displayed with correct values for Tuition and Fees
    Then Tuition and Fee for this college is "$14,213" And AverageNavianceColleges is "$24,551"  displayed
  ...
  Scenario:  Verify  Out Of State Tuition amount
    When I open Tuition
    Then Display Out of state tuition for ThisCollege "$1" and AverageNavianceColleges is "$18,834"

  Scenario: Total Fees for In-State
    When I open Total Fees
    Then Display In state Total Fee for ThisCollege is "$14,212" and AverageNavianceColleges is "$8,095"

  Scenario: Total Fees for Out-Of State
    When I open Total Fees
    Then Display Out of State Total Fees for ThisCollege is "$14,212" and AverageNavianceColleges is "$8,140"
