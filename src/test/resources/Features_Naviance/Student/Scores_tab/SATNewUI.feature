  ...
  Scenario Outline: Enter SAT scores
   ...
   Then I verify the test scores with "<warning>" message displayed
    ...
    Examples:
      ...
      | Aisner, Cathy | 222  | 38      | 222               |  35     | 22        | 444        |  2016 |  key test scores| SAT  | January | 30  | 12th  | Date out of range, valid range is between March 2016 and today |
      | Aisner, Cathy | 222  | 38      | 222               |  35     | 22        | 444        |  2016 |  key test scores| SAT  | March   | 30  | 12th  |  |
      | Aisner, Cathy | 444  | 38      | 222               |  30     | 23        | 444        |  2016 |  key test scores| SAT  | March   | 30  | 12th  |  |
