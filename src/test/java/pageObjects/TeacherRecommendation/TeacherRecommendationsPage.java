...
public class TeacherRecommendationsPage extends BaseClass {
    ...
    @FindBy(how = How.CSS, using = "input[name=can_request_recommendations]")
    ...
    @FindBy(how = How.CSS, using = "#class")
    ...
    @FindBy(how = How.CSS, using = "select[name=start_year]")
    public static WebElement selStartYear;

    @FindBy(how = How.CSS, using = "select[name=end_year]")
    public static WebElement selEndYear;

    @FindBy(how = How.CSS, using = "#goList")
    public static WebElement btnGo;

    @FindBy(how = How.CSS, using = "input[name=updateSettings]")
    public static WebElement btn_save_setting;

    @FindBy(how = How.CSS, using = "input[name=changeRange]")
